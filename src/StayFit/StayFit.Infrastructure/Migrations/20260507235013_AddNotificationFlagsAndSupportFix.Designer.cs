...
namespace StayFit.Infrastructure.Migrations
{
    ...
    [Migration("20260507235013_AddNotificationFlagsAndSupportFix")]
    partial class AddNotificationFlagsAndSupportFix
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StayFit.Domain.Entities.SupportTicketReply", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("StayFit.Domain.Entities.SupportTicketReply", b =>
                {
                    b.HasOne("StayFit.Domain.Entities.SupportTicket", "Ticket")
                        .WithMany("Replies")
